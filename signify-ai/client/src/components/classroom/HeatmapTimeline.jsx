    ...
    <AnimatePresence>
      {isListening && (
        <motion.div 
          ...
          className="fixed bottom-4 left-4 right-4 z-40 max-w-5xl mx-auto"
        >
          <div className="bg-[#2B124C] border-2 border-[#522B5B] p-2.5 md:p-3 rounded-2xl shadow-[4px_4px_0px_#000000] flex items-center justify-between gap-3">
            {/* Time Stamp */}
            <div className="text-[#FBE4D8] font-black font-display w-12 md:w-16 text-center text-sm md:text-base">
              {formatTime(elapsed)}
            </div>

            {/* Timeline Bar */}
            <div className="flex-1 relative h-2 bg-[#190019] border border-[#522B5B] rounded-full mx-2 md:mx-4">
